...
if (isset($_POST['tombol_submit'])) {
    ...
    $last = query("SELECT id_bimbingan FROM bimbingan ORDER BY id_bimbingan DESC LIMIT 1");
    if ($last) {
        $num = (int) substr($last[0]['id_bimbingan'], 1) + 1;
        $id_bimbingan = "J" . str_pad($num, 3, "0", STR_PAD_LEFT);
    } else {
        $id_bimbingan = "J001";
    }

    // siapkan data untuk dikirim ke function
    $_POST['id_bimbingan'] = $id_bimbingan;
    $_POST['tanggal_input'] = date("Y-m-d H:i:s");

    if (tambah_bimbingan_dosen($_POST) > 0) {
        echo "<script>
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-md-inline">Nazwa Aulia Fitri</span>
              </a>
            </li>
          </ul>
        </div>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i><p>Data Bimbingan</p>
                    </a>
                  </li>
                  <li class="nav-item">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item"><a href="dashboard_mahasiswa.php">Data Mahasiswa</a></li>
